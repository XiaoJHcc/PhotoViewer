...
> **封板注记(2026-07-19)**:本文件为一/二期历史档案,考古专用。文中"锁定/新增"的设计(16×16 网格、3 层金字塔、5 标量、patch 压缩等)多处已被二期演进推翻,现行基建状态以根 `AGENTS.md` §5.4 + [plan-2-1 wrapup §0.2 与 §4 墓碑](dinov3-photo-ranking-plan-2-1-wrapup.md) 为准;三期基准见 [Training/plans/dinov3-photo-ranking-plan-3-0-charter.md](../Training/plans/dinov3-photo-ranking-plan-3-0-charter.md)。
