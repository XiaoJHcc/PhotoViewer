...
输出:
    PhotoViewer/Core/Exif/ExifSonyCipherTags.Generated.cs
"""
...
OUTPUT_PATH = REPO_ROOT / "PhotoViewer" / "Core" / "Exif" / "ExifSonyCipherTags.Generated.cs"
...
def generate_cs(decipher: list[int],
    ...
    out.append("")
    out.append("internal static partial class ExifSonyCipherTags")
    out.append("{")
