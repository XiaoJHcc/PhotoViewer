...
internal static partial class ExifChinese
{
    ...
    private static readonly IReadOnlyDictionary<string, string> _overrideNames =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            // ===== Sony 加密 MakerNote 解码字段 =====
            ["SonyISO"]                       = "SONY 感光度",
            ["SonyFNumber"]                   = "SONY 光圈",
            ["SonyFNumber2"]                  = "SONY 光圈",
            ["SonyExposureTime"]              = "SONY 快门速度",
            ["SonyExposureTime2"]             = "SONY 快门速度",
            ["SonyMaxApertureValue"]          = "SONY 最大光圈",
            ["Shutter"]                       = "快门",
            ["ShutterCount"]                  = "快门次数",
            ["ShutterCount2"]                 = "快门次数",
            ["ShutterCount3"]                 = "快门次数",
            ...
            ["AFAreaMode"]                    = "自动对焦区域",
            ["CreativeStyle"]                 = "创意风格",
            ["PictureProfile"]                = "图片配置文件 (PP)",
            ["APS-CSizeCapture"]              = "APS-C 裁切模式",
            ...
            ["ISOSetting"]                    = "ISO 设定",
            ["ISOAutoMin"]                    = "自动 ISO 下限",
            ["ISOAutoMax"]                    = "自动 ISO 上限",
