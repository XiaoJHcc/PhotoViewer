...
| [Exif/ExifLoader.cs](PhotoViewer/Core/Exif/ExifLoader.cs) | 元数据读取 | EXIF/XMP read, fast thumbnail stream, integrates Sony cipher tag decode. |
| [Exif/ExifSonyCipherTags.cs](PhotoViewer/Core/Exif/ExifSonyCipherTags.cs) | Sony 加密 tag 解码 | Decrypt Sony 0x94xx / 0x9050 MakerNote blocks. **Generated table** is in `*.Generated.cs` — do not edit by hand; regenerate via `Tools/generate-sony-cipher-tags.py`. |
...
| **文件管理** | [FolderViewModel.cs](PhotoViewer/ViewModels/FolderViewModel.cs) | (logic only) | Current folder path, `AllFiles`, filter + sort logic. |
...
| **缩略图栏** | `FolderViewModel` (shared) | [Views/Main/ThumbnailView.axaml](PhotoViewer/Views/Main/ThumbnailView.axaml) | Filmstrip; scroll sync + selection highlight. |
